...
'''
Set can ge generated by itearting through the coordinate space or packing the whole array off to openCL to be  processed on the openCL device you select
'''
